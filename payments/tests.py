...
class PaymentTests(TestCase):
    ...
    def test_user_can_view_own_payment(self):
        ...
        self.assertEqual(
            response.data["stripe_payment_intent_id"],
            "pi_test_123",
        )
    ...
    def test_user_can_create_payment(
        self,
    ...
    @patch("payments.views.create_payment_intent")
    def test_stripe_error_during_payment_creation(
        self,
        mock_create_payment_intent,
    ):
        import stripe

        mock_create_payment_intent.side_effect = stripe.error.StripeError(
            "Stripe error"
        )
    ...
    @patch("payments.views.create_payment_intent")
    def test_unexpected_error_during_payment_creation(
        self,
        mock_create_payment_intent,
    ):
        mock_create_payment_intent.side_effect = Exception(
            "Unexpected error"
        )
    ...
    @patch("payments.views.stripe.Webhook.construct_event")
    def test_duplicate_webhook_is_not_processed(
        self,
        mock_construct_event,
    ):
    ...
    @patch("payments.views.stripe.Webhook.construct_event")
    def test_unhandled_webhook_event(
        self,
        mock_construct_event,
    ):
        mock_construct_event.return_value = {
